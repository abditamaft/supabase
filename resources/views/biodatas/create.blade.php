...
<div class="max-w-2xl mx-auto bg-gray-800 p-8 rounded-lg shadow-lg mt-4">
    <h2 class="text-2xl font-bold text-yellow-500 mb-6">Tambah Biodata Diri</h2>
    
    <form action="{{ route('biodatas.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="mb-4">
            <label class="block text-gray-400 mb-2">NIM</label>
            <input type="text" name="nim" class="w-full bg-gray-700 border border-gray-600 rounded p-2 text-white focus:outline-none focus:border-blue-500" required>
        </div>
        <div class="mb-4">
            <label class="block text-gray-400 mb-2">Nama Lengkap</label>
            <input type="text" name="name" class="w-full bg-gray-700 border border-gray-600 rounded p-2 text-white focus:outline-none focus:border-blue-500" required>
        </div>
        <div class="mb-4">
        ...
        <div class="mb-4">
            ...
            <textarea name="address" class="w-full bg-gray-700 border border-gray-600 rounded p-2 text-white focus:outline-none focus:border-blue-500"></textarea>
        </div>
        <div class="mb-6">
            <label class="block text-gray-400 mb-2">Foto Profil</label>
